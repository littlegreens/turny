...
description: Create distinctive, production-grade frontend interfaces with high design quality. Use this skill when building web components, pages, or applications to avoid generic AI aesthetics.
globs: "**/*.{tsx,jsx,ts,js,html,css,scss}"
---
